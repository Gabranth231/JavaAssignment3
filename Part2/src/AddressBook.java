...
public class AddressBook extends JFrame {
   ...
   // reference to database access objector 
   ...
   private class SearchAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
         ...
         if ( lastName != null ) {
            ...
            // Execute search. If found(only one), AddressBookEntry
            // is returned containing data.
            // change to work with a list of AddressBookEntries

            List<AddressBookEntry> people = database.findPerson(lastName);


            if ( people != null ) {
               for(AddressBookEntry person: people) {
                  // create window to display AddressBookEntry
                  AddressBookEntryFrame addressBookEntryFrame =
                          createAddressBookEntryFrame();
                  addressBookEntryFrame.setAddressBookEntry(person);

                  // display window
                  desktop.add(addressBookEntryFrame);
                  addressBookEntryFrame.setVisible(true);
               }
            }
            else
               JOptionPane.showMessageDialog( desktop, 
